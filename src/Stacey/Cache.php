...
class Cache
{
  ...
  public $path_hash;
  public $cachefile;
  public $cache_prefix = 'c-';

  public function __construct($file_path, $template_file)
  {
  ...
  public function generate_hash($str)
  {
  ...
  public function get_full_cache()
  {
  ...
  public function delete_old_full_caches()
  {
    $old_caches = glob('./app/_cache/pages/all-content-*');
    foreach($old_caches as $file) unlink($file);
  }

  public function save_full_cache($full_cache, $hash)
  {
  ...
  public function create_full_cache($pages = null)
  {
  ...
  public function create($route)
  {
    ...
    if (isset($page->data['password_protect'])) new Auth($page->data['password_protect']);
