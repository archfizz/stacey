...
class Helpers
{
  ...
  public static function file_path_to_url($file_path)
  {
  ...
  public static function relative_root_path($url = '')
  {
  ...
  public static function last_modified($dir)
  {
    $last_modified = 0;
    if (is_dir($dir)) {
  ...
  public static function site_last_modified($dir = false)
  {
  ...
  public static function translate_named_entities($string)
  {
